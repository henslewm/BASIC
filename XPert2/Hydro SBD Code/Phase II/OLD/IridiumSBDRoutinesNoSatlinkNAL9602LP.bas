...
'
'-------------------------------------------------------------------------------
'Const True = -1  COMMENTED OUT AFTER UPGRADING DCP OS TO 3.11.0.14
'Const False = 0  COMMENTED OUT AFTER UPGRADING DCP OS TO 3.11.0.14
Const LoggingIn=2
Const LoggedIn=4
Const LF = Chr(10)
Const CR = Chr(13)
...
Const RebootOnModemFail = False      'Set true if want to auto-reboot after max modem init failures reached
...
Public Sub SCHED_PrintSTMsg
   StatusMsg "Current self-timed message = " + GetSTCurrentMessage
End Sub
'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX